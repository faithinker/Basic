...
//    var isDasLoginDisplay = false // 최초 로그인
...
//                BaseTabBarController.shared.checkLoginGuideTooltip(isShow: false)
//            }
...
//            if let isDasLogin = self?.isDasLoginDisplay, !isDasLogin {
//                BaseTabBarController.shared.checkLoginGuideTooltip(isShow: viewController.showLoginTooltip && AuthManager.current.isGuest)
//            }
//        })
    }
